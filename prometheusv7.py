...
small iteration
Change lookback to 10 years for bigger sample size. 

change meta model to look at monthly for accurate precision/recall/stats
...
Final Prediction: Market will go UP (Confidence: 85.87%)

Top Meta-Model Signals:
1. momentum_21: 0.2945
2. lstm_signal: 0.2808
3. ensemble_signal: 0.1849
4. mean_reversion_20: 0.1164
5. obv_signal: 0.0616
6. supertrend_cont: 0.0479
7. macd_cross: 0.0137
8. rsi_signal: 0.0000
9. bb_signal: 0.0000
10. yield_curve_signal: 0.0000
11. atr_signal: 0.0000
12. vix_signal: 0.0000
...
seeing a big difference here. Jump in precision for meta. Jump in everything for lstm.

Changing lookback years allowed model to learn well. 

However, the meta model seems to be underperforming against the LSTM and ensemble models.

What will happen if I change to weekly or biweekly time frame?
